...
public interface ITypeOptionService
{
    ...
    Task<CommonResponse> GetGroupTypeOptionsAsync(Guid? groupId, CancellationToken ct);
    Task<CommonResponse> GetTypeOptionAsync(Guid optionId, CancellationToken ct);
}
