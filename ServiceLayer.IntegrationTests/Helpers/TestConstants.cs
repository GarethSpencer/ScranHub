...
{
    public static readonly Guid TestUser1AdminId = Guid.Parse("00000000-0000-0000-0000-000000000001");
    public static readonly Guid TestUser2NonAdminId = Guid.Parse("00000000-0000-0000-0000-000000000002");
    ...
    public const string TestUser1AdminName = "Admin User";
    public const string TestUser2NonAdminName = "Non-Admin User";
    ...
    public const string TestUser1AdminEmail = "admin@example.com";
    public const string TestUser2NonAdminEmail = "nonadmin@example.com";
    ...
    public static readonly Guid TestCostOption6Id = Guid.Parse("00000000-0000-0000-0001-000000000006");
    ...
    public const string TestCostOption4Label = "Override 1";
    public const string TestCostOption5Label = "Override 2";
    public const string TestCostOption6Label = "Override 3";
