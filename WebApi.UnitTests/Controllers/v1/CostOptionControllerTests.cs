...
public class CostOptionControllerTests
{
    private readonly Mock<ICostOptionService> _costOptionServiceMock = new();
    ...
    private readonly CostOptionController _sut;
    private static readonly CancellationToken ct = CancellationToken.None;

    public CostOptionControllerTests()
    {
        _sut = new CostOptionController(
            _costOptionServiceMock.Object,
    ...
    public async Task SetCustomOptions_InvalidRequest_ReturnsBadRequest()
    {
        ...
        _costOptionServiceMock.Verify(s => s.SetGroupCustomOptionsAsync(It.IsAny<SetOptionsRequest>(), It.IsAny<CancellationToken>()), Times.Never);
    }
    ...
    public async Task SetCustomOptions_ValidRequest_ReturnsCorrectResult()
    {
        ...
        _costOptionServiceMock.Setup(s => s.SetGroupCustomOptionsAsync(It.IsAny<SetOptionsRequest>(), It.IsAny<CancellationToken>()))
    ...
    public async Task SetCustomOptions_ValidRequest_CallsServiceCorrectly()
    {
        ...
        _costOptionServiceMock.Verify(s => s.SetGroupCustomOptionsAsync(request, ct), Times.Once);
    }
    ...
    public async Task RemoveCustomOptions_ValidRequest_ReturnsCorrectResult()
    {
        ...
        _costOptionServiceMock.Setup(s => s.RemoveGroupCustomOptionsAsync(It.IsAny<Guid>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(expectedResponse);
    ...
    public async Task RemoveCustomOptions_ValidRequest_CallsServiceCorrectly()
    {
        ...
        _costOptionServiceMock.Verify(s => s.RemoveGroupCustomOptionsAsync(groupId, ct), Times.Once);
    }
    ...
    public async Task AddCustomOption_InvalidRequest_ReturnsBadRequest()
    {
        ...
        Assert.IsType<BadRequestObjectResult>(result);
        _costOptionServiceMock.Verify(s => s.AddOptionAsync(It.IsAny<SetOptionRequest>(), It.IsAny<CancellationToken>()), Times.Never);
    }
    ...
    public async Task AddCustomOption_ValidRequest_ReturnsCorrectResult()
    {
        ...
        _costOptionServiceMock.Setup(s => s.AddOptionAsync(It.IsAny<SetOptionRequest>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(expectedResponse);
    ...
    public async Task AddCustomOption_ValidRequest_CallsServiceCorrectly()
    {
        ...
        _costOptionServiceMock.Verify(s => s.AddOptionAsync(request, ct), Times.Once);
    }
    ...
    public async Task UpdateCustomOption_InvalidRequest_ReturnsBadRequest()
    {
        ...
        Assert.IsType<BadRequestObjectResult>(result);
        _costOptionServiceMock.Verify(s => s.UpdateOptionAsync(It.IsAny<Guid>(), It.IsAny<UpdateOptionRequest>(), It.IsAny<CancellationToken>()), Times.Never);
    }
    ...
    public async Task UpdateCustomOption_ValidRequest_ReturnsCorrectResult()
    {
        ...
        var request = new UpdateOptionRequest { Label = "Updated Label" };
        var expectedResponse = new CommonResponse { StatusCode = HttpStatusCode.OK };
        _costOptionServiceMock.Setup(s => s.UpdateOptionAsync(It.IsAny<Guid>(), It.IsAny<UpdateOptionRequest>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(expectedResponse);
    ...
    public async Task UpdateCustomOption_ValidRequest_CallsServiceCorrectly()
    {
        ...
        _costOptionServiceMock.Verify(s => s.UpdateOptionAsync(optionId, request, ct), Times.Once);
    }
    ...
    public async Task RemoveCustomOption_ValidRequest_ReturnsCorrectResult()
    {
        var optionId = Guid.NewGuid();
        var expectedResponse = new CommonResponse { StatusCode = HttpStatusCode.OK };
        _costOptionServiceMock.Setup(s => s.DeleteOptionAsync(It.IsAny<Guid>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(expectedResponse);
    ...
    public async Task RemoveCustomOption_ValidRequest_CallsServiceCorrectly()
    {
        ...
        _costOptionServiceMock.Verify(s => s.DeleteOptionAsync(optionId, ct), Times.Once);
    }
    ...
    public async Task ReorderCustomOptions_ValidRequest_ReturnsCorrectResult()
    {
        ...
        var expectedResponse = new CommonResponse { StatusCode = HttpStatusCode.OK };
        _costOptionServiceMock.Setup(s => s.ReorderOptionsAsync(It.IsAny<OrderOptionsRequest>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(expectedResponse);
    ...
    public async Task ReorderCustomOptions_ValidRequest_CallsServiceCorrectly()
    {
        ...
        _costOptionServiceMock.Verify(s => s.ReorderOptionsAsync(request, ct), Times.Once);
    }
    ...
    public async Task GetRatingOptionsForGroup_ValidRequest_ReturnsCorrectResult()
    {
        ...
        _costOptionServiceMock.Setup(s => s.GetGroupRatingOptionsAsync(It.IsAny<Guid?>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(expectedResponse);
    ...
    public async Task GetRatingOptionsForGroup_ValidRequest_CallsServiceCorrectly()
    {
        ...
        _costOptionServiceMock.Verify(s => s.GetGroupRatingOptionsAsync(groupId, ct), Times.Once);
    }
    ...
    public async Task GetRatingOption_ValidRequest_ReturnsCorrectResult()
    {
        ...
        _costOptionServiceMock.Setup(s => s.GetRatingOptionAsync(It.IsAny<Guid>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(expectedResponse);
    ...
    public async Task GetRatingOption_ValidRequest_CallsServiceCorrectly()
    {
        ...
        _costOptionServiceMock.Verify(s => s.GetRatingOptionAsync(optionId, ct), Times.Once);
    }
}