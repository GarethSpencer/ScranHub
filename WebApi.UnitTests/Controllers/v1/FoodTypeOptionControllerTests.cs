...
public class FoodTypeOptionControllerTests
{
    private readonly Mock<IFoodTypeOptionService> _foodTypeOptionServiceMock = new();
    ...
    private readonly FoodTypeOptionController _sut;
    private static readonly CancellationToken ct = CancellationToken.None;

    public FoodTypeOptionControllerTests()
    {
        _sut = new FoodTypeOptionController(
            _foodTypeOptionServiceMock.Object,
    ...
    public async Task SetCustomOptions_InvalidRequest_ReturnsBadRequest()
    {
        ...
        _foodTypeOptionServiceMock.Verify(s => s.SetGroupCustomOptionsAsync(It.IsAny<SetOptionsRequest>(), It.IsAny<CancellationToken>()), Times.Never);
    }
    ...
    public async Task SetCustomOptions_ValidRequest_ReturnsCorrectResult()
    {
        ...
        _foodTypeOptionServiceMock.Setup(s => s.SetGroupCustomOptionsAsync(It.IsAny<SetOptionsRequest>(), It.IsAny<CancellationToken>()))
    ...
    public async Task SetCustomOptions_ValidRequest_CallsServiceCorrectly()
    {
        ...
        _foodTypeOptionServiceMock.Verify(s => s.SetGroupCustomOptionsAsync(request, ct), Times.Once);
    }
    ...
    public async Task RemoveCustomOptions_ValidRequest_ReturnsCorrectResult()
    {
        ...
        _foodTypeOptionServiceMock.Setup(s => s.RemoveGroupCustomOptionsAsync(It.IsAny<Guid>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(expectedResponse);
    ...
    public async Task RemoveCustomOptions_ValidRequest_CallsServiceCorrectly()
    {
        ...
        _foodTypeOptionServiceMock.Verify(s => s.RemoveGroupCustomOptionsAsync(groupId, ct), Times.Once);
    }
    ...
    public async Task AddCustomOption_InvalidRequest_ReturnsBadRequest()
    {
        ...
        Assert.IsType<BadRequestObjectResult>(result);
        _foodTypeOptionServiceMock.Verify(s => s.AddOptionAsync(It.IsAny<SetOptionRequest>(), It.IsAny<CancellationToken>()), Times.Never);
    }
    ...
    public async Task AddCustomOption_ValidRequest_ReturnsCorrectResult()
    {
        ...
        _foodTypeOptionServiceMock.Setup(s => s.AddOptionAsync(It.IsAny<SetOptionRequest>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(expectedResponse);
    ...
    public async Task AddCustomOption_ValidRequest_CallsServiceCorrectly()
    {
        ...
        _foodTypeOptionServiceMock.Verify(s => s.AddOptionAsync(request, ct), Times.Once);
    }
    ...
    public async Task UpdateCustomOption_InvalidRequest_ReturnsBadRequest()
    {
        ...
        Assert.IsType<BadRequestObjectResult>(result);
        _foodTypeOptionServiceMock.Verify(s => s.UpdateOptionAsync(It.IsAny<Guid>(), It.IsAny<UpdateOptionRequest>(), It.IsAny<CancellationToken>()), Times.Never);
    }
    ...
    public async Task UpdateCustomOption_ValidRequest_ReturnsCorrectResult()
    {
        ...
        var request = new UpdateOptionRequest { Label = "Updated Label" };
        var expectedResponse = new CommonResponse { StatusCode = HttpStatusCode.OK };
        _foodTypeOptionServiceMock.Setup(s => s.UpdateOptionAsync(It.IsAny<Guid>(), It.IsAny<UpdateOptionRequest>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(expectedResponse);
    ...
    public async Task UpdateCustomOption_ValidRequest_CallsServiceCorrectly()
    {
        ...
        _foodTypeOptionServiceMock.Verify(s => s.UpdateOptionAsync(optionId, request, ct), Times.Once);
    }
    ...
    public async Task RemoveCustomOption_ValidRequest_ReturnsCorrectResult()
    {
        var optionId = Guid.NewGuid();
        var expectedResponse = new CommonResponse { StatusCode = HttpStatusCode.OK };
        _foodTypeOptionServiceMock.Setup(s => s.DeleteOptionAsync(It.IsAny<Guid>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(expectedResponse);
    ...
    public async Task RemoveCustomOption_ValidRequest_CallsServiceCorrectly()
    {
        ...
        _foodTypeOptionServiceMock.Verify(s => s.DeleteOptionAsync(optionId, ct), Times.Once);
    }
    ...
    public async Task GetTypeOptionsForGroup_ValidRequest_ReturnsCorrectResult()
    {
        ...
        _foodTypeOptionServiceMock.Setup(s => s.GetGroupTypeOptionsAsync(It.IsAny<Guid?>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(expectedResponse);
    ...
    public async Task GetTypeOptionsForGroup_ValidRequest_CallsServiceCorrectly()
    {
        ...
        _foodTypeOptionServiceMock.Verify(s => s.GetGroupTypeOptionsAsync(groupId, ct), Times.Once);
    }
    ...
    public async Task GetTypeOption_ValidRequest_ReturnsCorrectResult()
    {
        ...
        _foodTypeOptionServiceMock.Setup(s => s.GetTypeOptionAsync(It.IsAny<Guid>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(expectedResponse);
    ...
    public async Task GetTypeOption_ValidRequest_CallsServiceCorrectly()
    {
        ...
        _foodTypeOptionServiceMock.Verify(s => s.GetTypeOptionAsync(optionId, ct), Times.Once);
    }
}